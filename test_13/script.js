...
async function doSubmit() {
  ...
  const result = {
    ...
    topicStats, examName: 'UCAT Decision Analysis Mock', topicNumber: 1,
...
function renderResults(result, saveRes) {
  ...
  wrap.innerHTML = `
    <div class="res-hero">
      <div style="font-size:0.8rem;opacity:.55;text-transform:uppercase;letter-spacing:.08em;margin-bottom:8px">UCAT Decision Analysis Mock</div>
