const PASSAGES = {
  ...
  "P4": {
    ...
    "subject": "Verbal Reasoning",
    "title": "Passage 4",
    "text": "The American effort to send astronauts to the moon had its origins in an appeal President \nKennedy made to a special joint session of Congress on May 25, 1961: \"I believe this nation \nshould commit itself to achieving the goal, before this decade is out, of landing a man on the \nmoon and returning him safely to Earth.\"   At the time, the United States was still trailing the \nSoviet Union in space developments, and Cold War-era America welcomed Kennedy's bold \nproposal. In 1966, after five years of work by an international team of scientists and \nengineers, the National Aeronautics and Space Administration (NASA) conducted the first \nunmanned Apollo mission, testing the structural integrity of the proposed launch vehicle \nand spacecraft combination.    \nThen, on January 27, 1967, tragedy struck at Kennedy Space Center in Cape Canaveral, \nFlorida, when a fire broke out during a manned launch-pad test of the Apollo spacecraft and \nSaturn rocket. Three astronauts were killed in the fire. Despite the setback, NASA and its \nthousands of employees forged ahead, and in October 1968, Apollo 7, the first manned \nApollo mission, orbited Earth and successfully tested many of the sophisticated systems \nneeded to conduct a moon journey and landing.   In December of the same year, Apollo 8 \ntook three astronauts to the dark side of the moon and back, and in March 1969 Apollo 9 \ntested the lunar module for the first time while in Earth orbit. That May, the three \nastronauts of Apollo 10 took the first complete Apollo spacecraft around the moon in a dry \nrun for the scheduled July landing mission. \nSource: https://www.history.com/topics/space-exploration/moon-landing-1969"
  },
  "P5": {
    "id": "P5",
    "subject": "Verbal Reasoning",
  ...
  "P10": {
    ...
    "subject": "Verbal Reasoning",
    "title": "Passage 10",
    "text": "Candles have been used as a source of light and to illuminate celebrations for more than \n5,000 years, yet little is known about their origin.  The earliest use of candles is often \nattributed to the Ancient Egyptians, who made rushlights or torches by soaking the pithy \ncore of reeds in melted animal fat. However, the rushlights had no wick like a true candle.   \nWhile the Egyptians were using wicked candles in 3,000 B.C., the ancient Romans are \ngenerally credited with developing the wicked candle before that time by dipping rolled \npapyrus repeatedly in melted tallow or beeswax. The resulting candles were used to light \ntheir homes, to aid travelers at night, and in religious ceremonies.  Historians have found \nevidence that many other early civilizations developed wicked candles using waxes made \nfrom available plants and insects. Early Chinese candles are said to have been molded in \npaper tubes, using rolled rice paper for the wick, and wax from an indigenous insect that \nwas combined with seeds. In Japan, candles were made of wax extracted from tree nuts, \nwhile in India, candle wax was made by boiling the fruit of the cinnamon tree.  It is also \nknown that candles played an important role in early religious ceremonies. Hanukkah, the \nJewish Festival of Lights which centers on the lighting of candles, dates back to 165 B.C. \nThere are several Biblical references to candles, and the Emperor Constantine is reported to \nhave called for the use of candles during an Easter service in the 4th century. \nSource: https://candles.org/history/"
  },
  "P11": {
    "id": "P11",
    "subject": "Verbal Reasoning",
    "title": "Passage 11",
    "text": "Malaysia does not have a good record in traffic law enforcement. According to the WHO, \nthe enforcement of laws in Malaysia related to speed limits, drink-driving, motorcycle \nhelmets and seat belts was ranked between 4 to 5 in a range of 0 to 10. Singapore's \nenforcement was ranked between 7 to 9. Strict traffic law enforcement is partly responsible \nfor the low traffic fatalities in Singapore where there are only 4 deaths per 100,000 \npopulation. Malaysia has about 24 deaths per 100,000 population. \nIn 2013 Singapore saw an annual 10.6 percent decrease in the number of fatal and injury \naccidents on their roads. Meanwhile in 2012 Malaysia had an annual 2.98 percent increase \nin the number of road accidents. The Perception of Being Caught (POBC) rate among \nMalaysian road users is low, at a 25 percent rate on regular days and a 50 percent rate \nduring the festive seasons. In developed countries, the POBC rate is between 80-90 percent. \nWe have to raise the POBC rate to a high level to instil discipline among Malaysian drivers \nand to do this we have to drastically improve our culture of enforcement among our \nauthorities and reduce the culture of lawlessness among our drivers. Our enforcement of \ntraffic laws has been lackadaisical, inefficient, corrupt and seasonal, leading to motorists not \nfearing the laws and breaking them at will. \n\n--- PAGE 406 ---\nMotorists simply do not fear being caught as traffic summonses are often not paid, can be \nnegotiated or cancelled through corruption and even discounts can be officially given. \nSource: https://www.malaysiakini.com/letters/269749"
  }
};
...
const QUESTIONS = [
  {
    "passageId": "P1",
    "text": "Why did the Venetians step back from the battle?",
    "options": [
      "Due to the Ottomans exchanging fire.",
      "Due to the command of Pietro Loredan.",
      "Due to transport issues in the Aegean Sea.",
      "Due to the death of the Ottoman admiral."
    ],
  ...
  {
    "passageId": "P1",
    "text": "Where did the Venetians head to after the battle?",
    "options": [
      "Gallipoli",
      "Tenedos",
      "Aegean Sea",
  ...
  {
    "passageId": "P1",
    "text": "What did the Ottomans promise the Venetians? \n\n--- PAGE 394 ---",
    "options": [
      "That they would defeat them in the battle.",
      "That they would welcome them.",
      "That they would not enslave any of the captives.",
      "That they would help them to travel back home."
    ],
    "topic": "Verbal Reasoning",
    "answer": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "Pietro Loredan was present during the Battle of Gallipoli.",
      "The Venetians were known for always executing their captives of war."
    ],
    "topic": "Verbal Reasoning",
    "answer": 2,
  ...
  },
  {
    ...
    "options": [
      ...
      "Coal from Texas cannot be transported to other parts of the country.",
      "Carbonization can take millions of years."
    ],
    "topic": "Verbal Reasoning",
    "answer": 1,
    "explanation": "The second and third paragraphs explain the process of coal formation, with initiates from plants and algae.",
    "id": 6
  },
  {
    "passageId": "P2",
    "text": "What best describes the condition of Earth around 300 million years ago?",
    "options": [
      "Deep seas and wide forests",
      "Lots of vegetation",
      "Large amounts of algae",
      "Wide seas and deep forests"
    ],
    "topic": "Verbal Reasoning",
    "answer": 3,
  ...
  },
  {
    ...
    "options": [
      ...
      "It begins as peat bogs which then break down into plant matter to form coal.",
      "It begins as mud, which is carbonised to form coal."
    ],
    "topic": "Verbal Reasoning",
    "answer": 0,
  ...
  },
  {
    ...
    "topic": "Verbal Reasoning",
    "answer": 1,
    "explanation": "The decline began in 1800 BC and Dilmun was absorbed entirely by Babylon in 600 BC. This is found in the second paragraph. Be careful not to use any outside knowledge, as this may lead you to selecting option A.",
    "id": 9
  },
  {
    "passageId": "P3",
    "text": "What was Dilmun described as in old poetry?",
    "options": [
      "Successful",
      "Noble",
      "Paradise",
  ...
  },
  {
    ...
    "options": [
      ...
      "Due to the conquest by Greece.",
      "Due to the Bahrain International Museum."
    ],
    "topic": "Verbal Reasoning",
    "answer": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "The residents of Saudi Arabia were commercially active.",
      "The behaviours of the people of Dilmun suggested that the empire was well- developed. --- PAGE 397 --- 397"
    ],
    "topic": "Verbal Reasoning",
    "answer": 3,
  ...
  {
    "passageId": "P4",
    "text": "What was the adversity that took place before the successful orbit around Earth?",
    "options": [
      "Difficulty landing on the moon.",
      "Death of astronauts.",
      "Thousands of employees were killed in a fire.",
      "Problems with the structural integrity of the launch."
    ],
    "topic": "Verbal Reasoning",
    "answer": 1,
  ...
  {
    "passageId": "P4",
    "text": "According to the passage, which Apollo mission landed on the moon?",
    "options": [
      "Apollo 11",
      "Apollo 9",
      "Apollo 10",
    ...
    "topic": "Verbal Reasoning",
    "answer": 3,
    "explanation": "None of the missions in the passage landed on the moon. Be careful not to use outside knowledge, as this may lead you to selecting option A.",
    "id": 14
  },
  {
    "passageId": "P4",
  ...
  {
    "passageId": "P4",
    "text": "When was the first unmanned Apollo mission?",
    "options": [
      "1971",
      "1968",
      "1966",
  ...
  {
    "passageId": "P5",
    "text": "Most of the artists of the time conducted thorough full body dissections.",
    "options": [
      "True",
      "False",
      "Can’t tell"
  ...
  {
    "passageId": "P5",
    "text": "Giorgio Vasari was a great Florentine sculptor.",
    "options": [
      "True",
      "False --- PAGE 399 ---",
      "Can’t tell"
  ...
  {
    "passageId": "P5",
    "text": "All Italian Renaissance artists had greater knowledge of anatomy than was taught at \nuniversities.",
    "options": [
      "True",
      "False",
      "Can’t tell"
  ...
  {
    "passageId": "P5",
    "text": "Pollaiuolo conducted his own research to learn about the human body.",
    "options": [
      "True",
      "False",
      "Can’t tell"
  ...
  {
    "passageId": "P6",
    "text": "Around 1000 BC, the first people arrived in the Americas.",
    "options": [
      "True",
      "False",
      "Can’t tell"
  ...
  {
    "passageId": "P6",
    "text": "Tribes in Mexico fed on deer and bison.",
    "options": [
      "True",
      "False",
      "Can’t tell"
    ...
    "topic": "Verbal Reasoning",
    "answer": 2,
    "explanation": "It is stated that they hunted deer and bison, but does not explicitly state that these were used for food.",
    "id": 22
  },
  {
    "passageId": "P6",
    "text": "There was a climate change around 10,000 years ago.",
    "options": [
      "True",
      "False",
      "Can’t tell"
  ...
  {
    "passageId": "P6",
    "text": "Boats were exclusively used for travel by the Native Americans.",
    "options": [
      "True",
      "False",
      "Can’t tell"
  ...
  },
  {
    ...
    "options": [
      "Conquering land",
      "Glory and riches",
      "To gain the Spanish crown",
      "To gain power as the leader of his army"
    ],
    "topic": "Verbal Reasoning",
    "answer": 1,
  ...
  {
    "passageId": "P7",
    "text": "Which year did Hernando de Soto pass away?",
    "options": [
      "1532",
      "1541",
      "1538",
  ...
  {
    "passageId": "P7",
    "text": "Who was the leader of the expedition that Hernando went on at the age of \neighteen?",
    "options": [
  ...
  {
    "passageId": "P8",
    "text": "Which side of the Mediterranean connects with the Atlantic Ocean?",
    "options": [
      "Southeast",
      "West",
      "Southwest",
  ...
  },
  {
    ...
    "options": [
      ...
      "Sea of Marmara",
      "The strait of the Bosporus --- PAGE 403 --- 403"
    ],
    "topic": "Verbal Reasoning",
    "answer": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "A rose with 60 petals would rebloom in under 30 days.",
      "Roses with less petals are more likely to live longer."
    ],
    "topic": "Verbal Reasoning",
    "answer": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "The bud of the rose is formed before the stem.",
      "New stems are formed due to deadheading. --- PAGE 404 --- 404"
    ],
    "topic": "Verbal Reasoning",
    "answer": 3,
  ...
  {
    "passageId": "P9",
    "text": "The majority of roses sold in stores are:",
    "options": [
      "Have between 5 and 12 petals.",
      "Last for 10-14 days.",
      "Are repeat bloomers.",
      "Will rebloom in 28-32 days."
    ],
    "topic": "Verbal Reasoning",
    "answer": 2,
  ...
  },
  {
    ...
    "options": [
      ...
      "Many different populations of people around the world have been using candles for thousands of years.",
      "Constantine was the first emperor to use candles in his ceremonies. --- PAGE 405 --- 405"
    ],
    "topic": "Verbal Reasoning",
    "answer": 2,
    "explanation": "This is evidenced throughout the passage with the mention of various countries.",
    "id": 37
  },
  {
    "passageId": "P10",
    ...
    "options": [
      ...
      "Candle wicks were made from reeds in Ancient Egypt.",
      "Candle wicks were made from tree nuts in India."
    ],
    "topic": "Verbal Reasoning",
    "answer": 1,
  ...
  {
    "passageId": "P10",
    "text": "What best describes the usage of candles mentioned by the passage between the \nyears 300 and 399?",
    "options": [
      "Easter",
      "Hannukah",
      "Illuminating celebrations",
  ...
  },
  {
    ...
    "options": [
      ...
      "For use by travellers on their night journeys",
      "To celebrate certain religious ceremonies"
    ],
    "topic": "Verbal Reasoning",
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Malaysia may have more deaths due to a larger population than Singapore.",
      "There is poor law enforcement in Malaysia."
    ],
    "topic": "Verbal Reasoning",
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "When motorists are caught speeding, they will carry on speeding in the future as they do not think they will get caught again.",
      "Drivers from Malaysia do not follow the traffic laws in other countries either."
    ],
    "topic": "Verbal Reasoning",
    "answer": 1,
    "explanation": "This shows how an individual can change their response to traffic laws based on how they perceive their likelihood of being caught. A is simply rewording the question; C only refers to speeding; D does not answer the question, as POBC is not discussed.",
    "id": 42
  },
  {
    "passageId": "P11",
  ...
  },
  {
    ...
    "options": [
      ...
      "Prohibition of healthcare to those responsible for collisions"
    ],
    "topic": "Verbal Reasoning",
    "answer": 1,
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "There is no information given in this graph to suggest that the cancers are non-contagious. Remember not to use any outside knowledge.",
    "topic": "Decision Making"
  },
  {
    "id": 47,
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "The blue bar, representing males, is largest for prostate cancer. This conclusion can be made as it refers to diagnoses in the population of the graph, rather than extrapolating data to include a larger population, such as the entire UK. Further, it can logically be inferred that cancers at these sites are registered, and so, the conclusion can be drawn that prostate cancer was the most commonly diagnosed cancer in males within the population of the study.",
    "topic": "Decision Making"
  },
  {
    "id": 49,
    ...
    "answer": 0,
    "explanation": "The bar for colorectal cancer is evidently the third largest bar including both men and women.",
    "topic": "Decision Making"
  },
  {
    "id": 50,
    ...
    "options": [
      ...
      "<img src=\"image/q2_opt_C.png\" style=\"max-height:100px;\">",
  ...
  },
  {
    "id": 51,
    "passageId": null,
    "text": "David has recently moved apartments and needs a new TV for his living room. There are 3 \nsizes available in store; pequena, mediana and grande. Each size differs only in length. When \n3 pesquena, 6 mediana & 4 grande are lined up together, the total length is 231 inches. \n \n \n \n \n \n \n \n \n \n \n \n\n--- PAGE 409 ---\nPequena are 2 inches shorter than mediana TVs. When 2 pequena and 1 grande are lined \nup, the length is 51 inches. The difference between pequena and mediana TV sizes is half \nthe difference between mediana and grande.  \n \nWhat is the length of grande in inches?",
    "options": [
      "15",
      "17",
      "21",
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "There is not enough information given to draw this conclusion.",
    "topic": "Decision Making"
  },
  {
    "id": 54,
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Bees are insects and therefore do not crawl.",
    "topic": "Decision Making"
  },
  {
    "id": 56,
    ...
    "answer": 0,
    "explanation": "All insects with wings are bees, so if it does not have wings, it is not a bee.",
    "topic": "Decision Making"
  },
  {
    "id": 57,
    ...
    "answer": 0,
    "explanation": "Euclid likes numbers with increasing digits, and 9 is larger than 3.",
    "topic": "Decision Making"
  },
  {
    "id": 58,
    ...
    "answer": 1,
    "explanation": "Pythagoras does not like any number that Archimedes likes.",
    "topic": "Decision Making"
  },
  {
    "id": 59,
    ...
    "answer": 0,
    "explanation": "Since Archimedes and Euclid both must like the number, the number must have increasing digits and contain the digit 1. The only way this is possible is with the first digit being 1.",
    "topic": "Decision Making"
  },
  {
    "id": 60,
    ...
    "answer": 0,
    "explanation": "Pythagoras only likes 3-digit numbers. Euclid likes numbers with increasing digits, which suggests that they need to have more than one digit to have an increasing trend. The only person who has no requirements other than the digit 1 in the number is Archimedes, hence, only one of the three can like single-digit numbers.",
    "topic": "Decision Making"
  },
  {
    "id": 61,
    ...
    "answer": 1,
    "explanation": "The number 187 does not have an increasing trend within its digits, and hence, Euclid would not like it.",
    "topic": "Decision Making"
  },
  {
    "id": 62,
    ...
    "options": [
      ...
      "Jaspreet and Harvin are both above the average height values for the UK.",
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Based on the information, all apple are red. If all apples are red, then some of them will definitely be red. Thus, this conclusion can be drawn.",
    "topic": "Decision Making"
  },
  {
    "id": 64,
    ...
    "answer": 0,
    "explanation": "If some strawberries are yellow, and all of the other items are red, strawberries must be either red or yellow.",
    "topic": "Decision Making"
  },
  {
    "id": 65,
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "There is not enough information given to make this conclusion. Syllogisms do not always make sense. It is possible that even though all baskets are strawberries, some mangoes might be baskets, or all mangoes might be baskets while all baskets are strawberries. For a conclusion to be drawn, there needs to be 100% certainty based on the information given, and in this case, there is not.",
    "topic": "Decision Making"
  },
  {
    "id": 67,
    ...
    "answer": 1,
    "explanation": "All baskets are strawberries, and strawberries are either red or yellow, thus baskets will be either red or yellow.",
    "topic": "Decision Making"
  },
  {
    "id": 68,
    "passageId": null,
    "text": "Should voting in the general election be made compulsory for citizens of France in order to \nincrease the number of voters? \n \nSelect the strongest argument from the statements below.",
    "options": [
      "Yes, because research suggests people who should vote do not due to lack of public \ntransport.",
      "Yes, because we have the choice to do what we want and the government should \nnot force things on us.",
      "No, because research shows that there was no increase in voters from 2014 to 2015 \nwhen Pakistan made it compulsory to vote.",
      "No, because the whole point of a democracy is to give a choice to people and here \nyou are going against that. \n\n--- PAGE 411 ---"
    ],
    "answer": 2,
    "explanation": "The answer is evidence based and is related to the issue at hand, i.e. increasing the number of voters. The other options are either unrelated or lack an evidence base, thus making them weaker arguments than option C.",
    "topic": "Decision Making"
  },
  {
    "id": 69,
    ...
    "options": [
      ...
      "Jared is 4th in line.",
      "Demetrius is 3 places ahead of Billy."
    ],
    "answer": 1,
    "explanation": "The order from first in line to last in line is as follows: Huzaifa, Demetrius, Fabrice, Sky, Jared, Billy.",
    "topic": "Decision Making"
  },
  {
    "id": 70,
    ...
    "options": [
      ...
      "<img src=\"image/q10_opt_C.png\" style=\"max-height:100px;\">",
  ...
  },
  {
    "id": 71,
    "passageId": null,
    "text": "Should the U.K government help tackle obesity by giving bicycle grants to citizens with a \nbody mass index (BMI) of 28+? \n \nSelect the strongest argument from the statements below.",
    "options": [
      "Yes, because this will help people purchase bicycles who otherwise could not afford \nto pay for them.",
      "Yes, because this was done in Italy in 2015 and an analysis of the changes showed \nthat more people with obesity were able to exercise.",
      "No, because people with a BMI of 28+ are unlikely to exercise.",
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "There is no mention of whether Dora might have black playing cards.",
    "topic": "Decision Making"
  },
  {
    "id": 74,
    ...
    "answer": 0,
    "explanation": "Armani has no black playing cards, regardless of whether they are shiny, while Dora has no shiny playing cards, regardless of whether they are black.",
    "topic": "Decision Making"
  },
  {
    "id": 75,
    ...
    "answer": 1,
    "explanation": "There is no mention of whether Armani has any blue cards.",
    "topic": "Decision Making"
  },
  {
    "id": 76,
  ...
  },
  {
    "id": 77,
    "passageId": null,
    "text": "--- PAGE 413 ---\n22 boys and 7 girls are asked to select what sports they play during a survey. 7 people said \nthey play tennis and 5 people said they play football. Hockey is played by 11 people and only \n4 people play cricket. 2 people did not play any sports. We also are told that, 2 people play \ntennis and football, 1 person plays hockey and football, and 3 people play tennis and cricket.  \n \nSelect the most accurate representation from the choices below.<br><br><img src=\"image/page_413_Image1336.png\" style=\"max-width:100%;\"><br><img src=\"image/page_413_Image1337.png\" style=\"max-width:100%;\"><br><img src=\"image/page_413_Image1338.png\" style=\"max-width:100%;\">",
    "options": [
      "A",
      "B",
      "C",
  ...
  },
  {
    "id": 78,
    "passageId": null,
    "text": "The diagram below represents the number of students taking various modules during their \n2nd year in university: \n \n \n \n\n--- PAGE 414 ---\nIn a particular year, the university announces that all students who study 3 or more modules \nin year 2 will receive an additional grant. How many students will receive this grant?<br><br><img src=\"image/page_414_Image1341.png\" style=\"max-width:100%;\">",
    "options": [
      "25",
      "60",
      "9",
    ...
    "answer": 0,
    "explanation": "Add up the numbers in the areas with 3 or more shapes overlapping, i.e. 9 and 16.",
    "topic": "Decision Making"
  },
  {
    "id": 79,
    ...
    "answer": 1,
    "explanation": "There is no information given to suggest this.",
    "topic": "Decision Making"
  },
  {
    "id": 80,
    ...
    "answer": 0,
    "explanation": "The testing capacity is represented by the grey line, which is always higher than the blue line which represents the number of tests processed.",
    "topic": "Decision Making"
  },
  {
    "id": 81,
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "There is no information given about the number of infections.",
    "topic": "Decision Making"
  },
  {
    "id": 83,
    ...
    "answer": 1,
    "explanation": "There is no bar on 29th March, suggesting that there were no tests conducted on that day. Further, there is no information about whether testing began during the dates on this graph, or whether this is merely a sample of time when testing was taking place.",
    "topic": "Decision Making"
  },
  {
    "id": 84,
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "h = heart, t = triangle, d = diamond Equation 2: 2d = h Equation 3: 2h = t + d Substitute equation 2 into equation 3: 2(2d) = t + d 4d = t + d t = 3d Substitute t into the final equation (2t = 2h + ?): 2(3d) = 2h Substitute equation 2 into the final equation: 2(3d) = 2(2d) + ? 6d = 4d + ? 2d is needed to satisfy the equation, and we know that h = 2d.",
    "topic": "Decision Making"
  },
  {
    "id": 86,
  ...
  },
  {
    "id": 87,
    "passageId": null,
    "text": "Should certain drugs like marijuana be legalised to reduce drug crime in the United \nKingdom? \n \nSelect the strongest argument from the statements below.",
    "options": [
      "Yes, because this may reduce the number of citizens arrested for crime every year.",
      "Yes, because the greatest marijuana-related crime is for possession, so legalising \nmarijuana will reduce crime rates.",
      "No, because marijuana-related crime is scarce, so this will likely not have a large \nimpact on crime rates.",
  ...
  },
  {
    ...
    "options": [
      ...
      "Students returning to university in Leeds are a contributory factor in the increased \ninfection rates.",
  ...
  },
  {
    "id": 90,
    "passageId": null,
    "text": "A survey is performed to identify how many patients use a blue inhaler, brown inhaler & \npink inhaler. 45 patients used the pink inhaler, 19 used the brown inhaler and only 8 used a \nblue inhaler. 8 use both a pink and brown inhaler while 2 use both a blue and brown inhaler. \nNo patients used a pink and blue inhaler. There were 110 participants in the survey.   \n \nWhat is the probability that a patient picked at random from the survey used a brown \ninhaler only?",
    "options": [
      "37/110",
      "8/110",
      "6/110",
    ...
    "answer": 3,
    "explanation": "The total number of patients who use a brown inhaler is 19. There are 10 patients who use a brown inhaler and another inhaler as well. 19-10=9, so there are 9 patients who use only a brown inhaler. The total number of participants is 110, so 9/110 use only a brown inhaler.",
    "topic": "Decision Making"
  },
  {
    "id": 91,
    ...
    "answer": 1,
    "explanation": "There are 3 rugs and 6 cupboards.",
    "topic": "Decision Making"
  },
  {
    "id": 92,
    ...
    "answer": 1,
    "explanation": "There is no information given about how many of the chairs are wooden. It is equally possible based on the information that all chairs are wooden, or that only 1 chair is wooden. Thus, we cannot draw a conclusion about the number of wooden chairs.",
    "topic": "Decision Making"
  },
  {
    "id": 93,
    ...
    "answer": 0,
    "explanation": "D. The correct answer is No. Only chairs and tables are wooden.",
    "topic": "Decision Making"
  },
  {
    "id": 94,
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "There is no information given regarding the material of the rugs.",
    "topic": "Decision Making"
  },
  {
    "id": 96,
    ...
    "answer": 0,
    "explanation": "A biased coin simply means that the chance of landing on either heads or tails is not equal, i.e. there is a greater than 50% chance of landing on one of the sides. This does not lead to a change in probability based on the results of previous coin tosses.",
    "topic": "Decision Making"
  },
  {
    "id": 97,
    ...
    "answer": 1,
    "explanation": "All black cases are shiny, but there is nothing to suggest that shiny cases have to be black.",
    "topic": "Decision Making"
  },
  {
    "id": 98,
    ...
    "answer": 1,
    "explanation": "All black cases are shiny, but there is nothing to suggest that they cannot also be clear. Syllogisms will not always make sense, as you will have seen by now.",
    "topic": "Decision Making"
  },
  {
    "id": 99,
    ...
    "answer": 0,
    "explanation": "No grey cases are shiny, as evidenced by the text.",
    "topic": "Decision Making"
  },
  {
    "id": 100,
    ...
    "answer": 0,
    "explanation": "Although there is no mention of blue cases, there is nothing excluding other colours from being shiny.",
    "topic": "Decision Making"
  },
  {
    "id": 101,
  ...
  },
  {
    "id": 102,
    "passageId": null,
    "text": "Should university fees be reduced in order to attract more students from disadvantaged \nbackgrounds? \n \nSelect the strongest argument from the statements below.",
    "options": [
      "Yes, because fees may be the biggest factor in students not taking up places in \nuniversities.",
      "Yes, because disadvantaged students cannot afford to study at the moment due to \nthe tuition fee hike and are only able to study If successful in scholarship \nprogrammes.",
      "No, because education does have a cost to it and people should work hard to have \nthis privilege.",
      "No, because disadvantaged students are better suited to non-university based \ncourses."
    ],
    "answer": 1,
    "explanation": "This focusses specifically on disadvantaged students, whereas option A focusses on students in general. Option C is opinionated, whereas option D is an argument without a premise.",
    "topic": "Decision Making"
  },
  {
    "id": 103,
    "passageId": null,
    "text": "Aaqib, Mahdi, Habib, Mustafa, Amin and Sadiq visit a theme park together just before \nclosing time. They only had enough time to go on one ride. The rides are either water, roller-\ncoaster or skyscrapers in type and either small, medium or large in size. \n\n--- PAGE 420 ---\nOnly one of them went on a large rollercoaster \nSadiq went on a large water ride \nHabib did not go on a skyscraper \n3 people in total went on a water ride \nAll skyscrapers are small \n2 people had small sized rides only \nAaqib went on the exact same ride as Sadiq \nMahdi did not go on a rollercoaster or a skyscraper \nOnly Mustafa went on a medium sized ride \nOnly 1 person went on a skyscraper \n \nWho went on a skyscraper?",
    "options": [
      "Habib",
      "Sadiq",
      "Mahdi",
    ...
    "answer": 3,
    "explanation": "Although this one may look complicated, and you may automatically begin to draw your table, try to read the question first. You can easily answer this question by a process of elimination. It cannot be option A, as the question states that Habib did not go on a skyscraper. It cannot be option B, as the question states that Aaqib and Sadiq went on the same ride, and only one person went on a skyscraper. It cannot be option C as Mahdi did not go on a rollercoaster or a skyscraper. Therefore, by process of elimination, the answer must be D.",
    "topic": "Decision Making"
  },
  {
    "id": 104,
    ...
    "answer": 1,
    "explanation": "There are 6 drinks and 12 fruits.",
    "topic": "Decision Making"
  },
  {
    "id": 105,
    ...
    "answer": 0,
    "explanation": "There are 12 drinks and 6 fruits.",
    "topic": "Decision Making"
  },
  {
    "id": 106,
    ...
    "answer": 1,
    "explanation": "There is at least 1 pizza, and there may be other frozen foods.",
    "topic": "Decision Making"
  },
  {
    "id": 107,
    ...
    "answer": 0,
    "explanation": "There are 3 strawberries and no fizzy drinks, as all of the drinks are not fizzy.",
    "topic": "Decision Making"
  },
  {
    "id": 108,
    ...
    "answer": 1,
    "explanation": "Although there are 26 items, there is nothing to suggest that the trolley is at its maximum capacity.",
    "topic": "Decision Making"
  },
  {
    "id": 109,
    "passageId": null,
    "text": "The diagram below shows the number of shoppers that purchased particular items from \ntheir local supermarket: \n\n--- PAGE 421 ---\nHow many shoppers purchased exactly 2 items?<br><br><img src=\"image/page_421_Image1355.png\" style=\"max-width:100%;\">",
    "options": [
      "29",
      "32",
      "48",
    ...
    "answer": 3,
    "explanation": "Add up all of the areas with 2 shapes overlapping.",
    "topic": "Decision Making"
  },
  {
    "id": 110,
  ...
  },
  {
    "id": 114,
    "passageId": null,
    "text": "<strong>Scenario:</strong>\nThe table shows the number of different services a barbershop was booked for over a 5-\nyear period.\n\n<strong>Question:</strong>\nWhat was the most popular service in 2020?",
    "options": [
      "Hair",
      "Beard",
      "Wax",
    ...
    "answer": 1,
    "explanation": "This looks at your ability to interpret simple data in a table.",
    "topic": "Quantitative Reasoning"
  },
  {
    "id": 115,
    "passageId": null,
    "text": "<strong>Scenario:</strong>\nThe table shows the number of different services a barbershop was booked for over a 5-\nyear period.\n\n<strong>Question:</strong>\nBy what percentage did hair bookings fall between 2016 and 2017? \n \nHair \nBeard \nWax \nFacial \nScalp Massage \n5,645 \n2,981 \n1,022 \n3,657 \n2017 \n4,316 \n1,054 \n2,792 \n1,790 \n2018 \n5,750 \n5,634 \n1,313 \n3,778 \n1,294 \n5,249 \n2,088 \n3,182 \n3,118 \n2020 \n5,309 \n5,713 \n1,899 \n2,626 \n--- PAGE 424 ---",
    "options": [
      "23.5%",
      "76.5%",
      "28.6%",
  ...
  },
  {
    "id": 116,
    "passageId": null,
    "text": "<strong>Scenario:</strong>\nThe table shows the number of different services a barbershop was booked for over a 5-\nyear period.\n\n<strong>Question:</strong>\nIn 2019, what percentage of bookings were for beard?",
    "options": [
      "15%",
      "38%",
      "23%",
  ...
  },
  {
    "id": 117,
    "passageId": null,
    "text": "<strong>Scenario:</strong>\nThe table shows the number of different services a barbershop was booked for over a 5-\nyear period.\n\n<strong>Question:</strong>\nThe barbershop opened in 2015 and the total number of bookings in its first year \nwas 6,763. What was the percentage increase in bookings between 2015 and 2016?",
    "options": [
      "92.4%",
      "96.7%",
      "196.7%",
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Each piece covers 0.96m2 and the area of the extended front room is 88m2. 88 / 0.96 = 91.67. This would need to be rounded up to 92 in order to cover the full floor, as you cannot purchase 0.67 of a piece.",
    "topic": "Quantitative Reasoning"
  },
  {
    "id": 121,
  ...
  },
  {
    "id": 126,
    "passageId": null,
    "text": "<strong>Scenario:</strong>\nKaram, Nav & Abraham are 3 friends who have recently started their studies at different \nuniversities in Canada. Karam studies in Calgary which is 299km from Edmonton, where Nav \nstudies. Abraham studies in Saskatoon which is 521km from Edmonton.  \n \n1mile= 1.6km\n\n<strong>Question:</strong>\nNav decides to travel to Saskatoon over the winter holidays. He drives for 3 hours \nbefore taking a 30-minute rest to get some food. He then continues his journey and \ndrives for a further 180 minutes before he reaches his destination. What was his \naverage speed during this trip in miles per hour?",
    "options": [
      "54.3 miles/hour",
      "80.2 miles/hour",
      "86.8 miles/hour",
  ...
  },
  {
    "id": 127,
    "passageId": null,
    "text": "<strong>Scenario:</strong>\nKaram, Nav & Abraham are 3 friends who have recently started their studies at different \nuniversities in Canada. Karam studies in Calgary which is 299km from Edmonton, where Nav \nstudies. Abraham studies in Saskatoon which is 521km from Edmonton.  \n \n1mile= 1.6km\n\n<strong>Question:</strong>\nKaram travels from Calgary to Saskatoon via train at a speed of 120 miles per hour. If \nhe had travelled on car, it would have taken him 6 hours and 20 minutes. By \ntravelling on train he saves 32 minutes of travel time.  What is the distance between \nCalgary and Saskatoon?",
    "options": [
      "696 miles",
      "488 miles",
      "600 miles",
  ...
  },
  {
    "id": 129,
    "passageId": null,
    "text": "<strong>Scenario:</strong>\nKaram, Nav & Abraham are 3 friends who have recently started their studies at different \nuniversities in Canada. Karam studies in Calgary which is 299km from Edmonton, where Nav \nstudies. Abraham studies in Saskatoon which is 521km from Edmonton.  \n \n1mile= 1.6km\n\n<strong>Question:</strong>\nAfter arriving in Calgary, Lucinda travels to Edmonton. She then travels to Saskatoon \nto visit Abraham. She catches a return flight from Saskatoon to Toronto. If the \ndistance travelled by air on the return flight is 6,442 miles, how many kilometres did \nshe travel after landing in Calgary, to the nearest whole number?",
    "options": [
      "6442",
      "4846",
      "11127",
  ...
  },
  {
    "id": 134,
    "passageId": null,
    "text": "<strong>Scenario:</strong>\nThe table shows the number of students studying particular healthcare courses at five \ndifferent universities in the UK. Each course is at its maximum capacity this year. \n \n \nMedicine \nPharmacy \nDentistry \nRadiography Physiotherapy \nUniversity of \nLiverpool \n16 \n44 \nUniversity of \nPlymouth \n43 \n19 \nUniversity of Luton \n56 \n21 \nUniversity of Sutton \n19 \n12 \nUniversity of \nNewcastle \n20 \n30 \n10\n\n<strong>Question:</strong>\nWhat is the mean number of students studying Medicine in the above universities, \nto the nearest whole number?",
    "options": [
      "70",
      "34 --- PAGE 430 ---",
      "80",
  ...
  },
  {
    "id": 135,
    "passageId": null,
    "text": "<strong>Scenario:</strong>\nThe table shows the number of students studying particular healthcare courses at five \ndifferent universities in the UK. Each course is at its maximum capacity this year. \n \n \nMedicine \nPharmacy \nDentistry \nRadiography Physiotherapy \nUniversity of \nLiverpool \n16 \n44 \nUniversity of \nPlymouth \n43 \n19 \nUniversity of Luton \n56 \n21 \nUniversity of Sutton \n19 \n12 \nUniversity of \nNewcastle \n20 \n30 \n10\n\n<strong>Question:</strong>\nWhich university has the highest total number of students studying the above \nhealthcare courses?",
    "options": [
  ...
  },
  {
    "id": 136,
    "passageId": null,
    "text": "<strong>Scenario:</strong>\nThe table shows the number of students studying particular healthcare courses at five \ndifferent universities in the UK. Each course is at its maximum capacity this year. \n \n \nMedicine \nPharmacy \nDentistry \nRadiography Physiotherapy \nUniversity of \nLiverpool \n16 \n44 \nUniversity of \nPlymouth \n43 \n19 \nUniversity of Luton \n56 \n21 \nUniversity of Sutton \n19 \n12 \nUniversity of \nNewcastle \n20 \n30 \n10\n\n<strong>Question:</strong>\nThe University of Sutton will increase all its course cohorts by 25% next year. How \nmany fewer students will study radiography at Sutton than Luton next year?",
    "options": [
      "11",
      "9",
      "6",
    ...
    "answer": 2,
    "explanation": "Sutton radiography students next year: 12 x 1.25 = 15. Luton will still have 21 students. The difference is 6.",
    "topic": "Quantitative Reasoning"
  },
  {
    "id": 137,
    "passageId": null,
    "text": "<strong>Scenario:</strong>\nThe table shows the number of students studying particular healthcare courses at five \ndifferent universities in the UK. Each course is at its maximum capacity this year. \n \n \nMedicine \nPharmacy \nDentistry \nRadiography Physiotherapy \nUniversity of \nLiverpool \n16 \n44 \nUniversity of \nPlymouth \n43 \n19 \nUniversity of Luton \n56 \n21 \nUniversity of Sutton \n19 \n12 \nUniversity of \nNewcastle \n20 \n30 \n10\n\n<strong>Question:</strong>\nWhich university has the median number of students studying Dentistry from the list \ntable above?",
    "options": [
      "University of Liverpool",
      "University of Plymouth",
      "University of Luton",
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Cameron sends the text message at 10:30 PM on Saturday in Dakar, and Abigail opens it at 11:30 PM in Dakar. Abigail is in Tokyo, which is 9 hours ahead of Dakar. 11:30 PM + 9 hours = 8.30 AM on Saturday.",
    "topic": "Quantitative Reasoning"
  },
  {
    "id": 140,
  ...
  },
  {
    ...
    "options": [
      ...
      "Gymnastics",
      "All-time Fitness",
      "Muscle House and All-time Fitness would be the same",
      "Runners"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "This is a good resolution as Rajesh can speak directly to the course director and work out another time for him to learn the relevant skills. This will help him to gain permission to take the time off and to ensure that his learning is not impacted.",
    "topic": "Situational Judgement"
  },
  {
    "id": 152,
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "If the patient is generally unwell or has a poor immune system, their risk of contracting hospital-acquired infections is greater. It is important to consider the health of the patient when determining how long to keep them in hospital.",
    "topic": "Situational Judgement"
  },
  {
    "id": 155,
  ...
  },
  {
    ...
    "answer": 3,
    "explanation": "It is not appropriate to miss a scheduled session without informing the relevant people in charge. Jen should make an effort to either contact her university or the tutor to report her absence.",
    "topic": "Situational Judgement"
  },
  {
    "id": 160,
    ...
    "answer": 1,
    "explanation": "It is most ideal to get in contact with the tutor so they are aware of why she is not present. However, if Jen has made an attempt and needs to rush out for an emergency, she can later explain herself. Although the tutor may be unaware of her absence during the session, they will likely understand when she explains that she tried to get in contact prior to missing the session.",
    "topic": "Situational Judgement"
  },
  {
    "id": 161,
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Smoking has a hugely detrimental effect on the health of a foetus, and so is one of the most important things to consider in this situation. It is also necessary to advise Mrs. Adams of the detrimental impact of her smoking.",
    "topic": "Situational Judgement"
  },
  {
    "id": 163,
    ...
    "answer": 0,
    "explanation": "It is always essential to consider the autonomy of patients. Regardless of what decisions they are making, you must remember that the patient has the right to make their own decisions.",
    "topic": "Situational Judgement"
  },
  {
    "id": 164,
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "As a flatmate, friend, and colleague, it is important to understand the reason for her recent changes. This will help Chris to deal with the matter empathetically and offer her the support that she may need. If he does not consider the reasons behind these changes, he may not be able to deal with them effectively.",
    "topic": "Situational Judgement"
  },
  {
    "id": 166,
  ...
  },
  {
    ...
    "answer": 3,
    "explanation": "This option has no resolution, embarrasses Javaid and Amy, and and presents opportunity for conflict.",
    "topic": "Situational Judgement"
  },
  {
    "id": 170,
  ...
  },
  {
    ...
    "answer": 3,
    "explanation": "As a medical student, Aryan has no right to prescribe medication. As he is not qualified, there is a significant risk of harm here and so this option would be very inappropriate.",
    "topic": "Situational Judgement"
  },
  {
    "id": 173,
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Asking another doctor to help is the most appropriate resolution as they will have the best knowledge of medications and will be better equipped to deal with the situation.",
    "topic": "Situational Judgement"
  },
  {
    "id": 175,
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "The fact that nobody has come forward probably means that there is nobody more qualified than her on the train.",
    "topic": "Situational Judgement"
  },
  {
    "id": 177,
    ...
    "answer": 3,
    "explanation": "This is completely irrelevant to the situation at hand. If she considers this, she may have an inappropriate intention when responding. She may act outside of her limitations if there are incentives being offered, therefore, she should focus on the issue at hand and ignore any incentives.",
    "topic": "Situational Judgement"
  },
  {
    "id": 178,
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "It is important to address the issue, but it is not appropriate to do so in this manner. Taking the junior doctor aside in front of Sharon may cause her to feel worse, as it would be evident that she was clearly upset. Further, it may make the junior doctor feel bad for unintentionally making an offensive remark. It --- PAGE 494 --- would be best to discuss this privately, rather than pulling them aside in front of Sharon.",
    "topic": "Situational Judgement"
  },
  {
    "id": 189,
    ...
    "answer": 1,
    "explanation": "An apology is required, but this is not ideal as it should be coming from the doctor who made the comment, not from Callum. However, it may help to de-escalate the situation if at least some form of apology is given, and the junior doctor may realise his mistake if Callum steps in with an apology.",
    "topic": "Situational Judgement"
  },
  {
    "id": 190,
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "The smallest and largest shapes swap, and the two middle shapes swap. All of the white colours become black, and all of the black colours become white.",
    "topic": "Situational Judgement"
  },
  {
    "id": 192,
    ...
    "answer": 0,
    "explanation": "The number of intersections stays constant. If a box has all curved lines, the next box will have all straight lines. Therefore, if a box has all straight lines, the next box will have all curved lines.",
    "topic": "Situational Judgement"
  },
  {
    "id": 193,
  ...
  },
  {
    ...
    "answer": 3,
    "explanation": "The coloured shape turns black and all those immediately adjacent to it within straight lines turn dark grey. The shapes next to the new dark grey shapes, which are not separated by the original coloured shape by any other shape, will turn light grey. Any shapes which are separated from the original shape by other shapes will not change in colour.",
    "topic": "Situational Judgement"
  },
  {
    "id": 195,
  ...
  },
  {
    ...
    "answer": 3,
    "explanation": "This can make Mike feel very attacked, and is not an appropriate form of conflict resolution. For Mike to better understand what he is doing wrong, he should be spoken to privately about the situation, rather than in front of a large group.",
    "topic": "Situational Judgement"
  },
  {
    "id": 199,
    ...
    "answer": 2,
    "explanation": "This is not appropriate as Jake is feeling uncomfortable, and is likely not the only person feeling like this, thus it should be addressed. However, it is not awful as it does not make the situation worse.",
    "topic": "Situational Judgement"
  },
  {
    "id": 200,
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "If the young patient is being abused at home, her safety and wellbeing are directly at risk, thus action needs to be taken. If she has nowhere else to safely stay, the medical team can make the decision to admit her to hospital to keep her in safe hands while arrangements are made and investigations are conducted.",
    "topic": "Situational Judgement"
  },
  {
    "id": 203,
  ...
  },
  {
    ...
    "answer": 3,
    "explanation": "It is important to be open to receiving both positive and negative feedback. To immediately claim that the comments are unfair is an immature and unprofessional approach. Healthcare professionals should seek to better themselves as much as possible, taking on board any feedback they receive.",
    "topic": "Situational Judgement"
  },
  {
    "id": 205,
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Although Dr Markham cannot decide who to give the liver to purely based on alcohol consumption, it is important to consider all aspects of each patient when making this important decision. This includes alcohol consumption, as excessive consumption can be very detrimental to the liver. It is permissible to offer a transplant to patients with a high level of alcohol consumption, but it is essential to provide lifestyle advice and ensure that the patient is willing to decrease consumption to allow success of the new organ.",
    "topic": "Situational Judgement"
  },
  {
    "id": 210,
