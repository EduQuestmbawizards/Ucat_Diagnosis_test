...
async function doSubmit() {
  ...
  const subtests = ['Verbal Reasoning'];
  const topicStats = {};
  ...
  const result = {
    ...
    topicStats, examName: 'UCAT Verbal Reasoning Mock 2', topicNumber: 0,
...
function renderResults(result, saveRes) {
  ...
  wrap.innerHTML = `
    <div class="res-hero">
      <div style="font-size:0.8rem;opacity:.55;text-transform:uppercase;letter-spacing:.08em;margin-bottom:8px">UCAT Verbal Reasoning Mock 2</div>
