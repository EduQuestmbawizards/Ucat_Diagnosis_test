...
async function doSubmit() {
  ...
  const subtests = ['Decision Making'];
  const topicStats = {};
  ...
  const result = {
    ...
    topicStats, examName: 'UCAT Decision Making Mock 2', topicNumber: 1,
...
function renderResults(result, saveRes) {
  ...
  wrap.innerHTML = `
    <div class="res-hero">
      <div style="font-size:0.8rem;opacity:.55;text-transform:uppercase;letter-spacing:.08em;margin-bottom:8px">UCAT Decision Making Mock 2</div>
